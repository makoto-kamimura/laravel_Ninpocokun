...
@section('body')
	<section>
        ...
        <form action="usertouroku_confirm" method="post">
        	...
        	<div class="name">
                <label for="employeecode">名前（漢字）</label>
                <input type="text" name="sei1" class="name" pattern="" placeholder="姓">
                <input type="text" name="mei1" class="name" pattern="" placeholder="名">
            </div>
            <div class="name">
